...
class TestConfigManager:
    ...
    def config_manager(self, temp_config_dir):
        ...
        with patch.object(XDGPaths, 'config_home', return_value=temp_config_dir):
            with patch.object(XDGPaths, 'data_home', return_value=temp_config_dir / "data"):
                with patch.object(XDGPaths, 'cache_home', return_value=temp_config_dir / "cache"):
                    with patch.object(XDGPaths, 'state_home', return_value=temp_config_dir / "state"):
            ...
            with patch.object(XDGPaths, 'data_home', return_value=temp_config_dir / "data"):
                with patch.object(XDGPaths, 'cache_home', return_value=temp_config_dir / "cache"):
                    with patch.object(XDGPaths, 'state_home', return_value=temp_config_dir / "state"):
                        ...
                        print(f"After reset - schedule.enabled: {config_manager.get('schedule.enabled')}")
    ...
    def test_config_merge_with_existing(self, temp_config_dir):
        ...
        partial_config = {
            ...
            "schedule": {
                "enabled": True,
                "light_time": "08:00"  # Override default
            }
        }
        ...
        assert config.get("schedule.light_time") == "08:00"  # Should be overridden value
